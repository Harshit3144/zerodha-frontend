        ...
        <div className='container mt-5'>
            ...
            <div className="row text-muted p-3" style={{ fontSize: "13px" }}>
                ...
                <div className="col-4 text-center  ">
                    <img src="media/zerodhaFundhouse.png" alt="zerodhaFundhouse" style={{ width: "160px" }} />
                    ...
                    <img src="media/streakLogo.png" alt="streakLogo" style={{ width: "160px" }} className=' mt-3' />
                    <p className=' mt-3'>Systematic trading platform that allows you to create and backtest strategies without coding.</p>
                </div>

                <div className="col-4 text-center ">
                    <img src="media/sensibullLogo.svg" alt="sensibullLogo" style={{ width: "180px" }} />
