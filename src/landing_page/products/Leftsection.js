            ...
            <div className='row p-3 '>
                ...
                <div className="col-5 p-5" style={{ width: "40%" }}>
                    ...
                    <div className="mb-3">
                        ...
                        <a href="https://zerodha.com/" style={{ textDecoration: "none" }}>Try demo<i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
                        <a href="https://zerodha.com/" style={{ textDecoration: "none" }}> Learn more<i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
                        <div className='row'>
            ...
            <div className='row p-3 '>
                ...
                <div className="col-5 p-5" style={{ width: "40%" }}>
                    ...
                    <div className="mb-3">
                        ...
                        <a href="https://zerodha.com/" style={{ textDecoration: "none" }}>Coin <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
                        <div className='row'>
                            <div className='col-6 mt-4'><img src="media/googlePlayBadge.svg" style={{ width: "90%" }} /></div>
                            <div className='col-6 mt-4'><img src="media/appstoreBadge.svg" style={{ width: "83%" }} /></div>
                        </div>
