    ...
    return ( <div className='container border-top mt-5 '>
        <div className='row mt-5'>
            <div className="col-4">
                ...
                <p className="p-0 text-muted">© 2010 - 2026, Zerodha Broking Ltd. All rights reserved.</p>
                <div className="row">
                    <div className="col-6">
                        <img src="media/googlePlayBadge.svg" alt="googlePlayBadge"/>
                    </div>
                    <div className="col-6">
                        <img src="media/appstoreBadge.svg" alt="appstoreBadge"/>
                    </div>
                </div>
            </div>
            <div className="col-2">
            ...
            <div className="col-2"><h3>Support</h3>
            ...
            <div className="col-2"><h3>Company</h3>
            ...
            <div className="col-2"><h3>Quick links</h3>
        ...
        <div className="mt-5 text-small text-muted " style={{fontSize:"13px"}}>
            ...
            <a href="https://zerodha.com/" style={{textDecoration:"none"}}>Smart Online Dispute Resolution | Grievances Redressal Mechanism</a>
